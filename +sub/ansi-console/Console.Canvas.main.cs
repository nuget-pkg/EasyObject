...
//css_nuget Spectre.Console.ImageSharp;
...
public static class Program
{
    public static void Main()
    {
        ...
        EasyObject.Echo(typeof(Program).Assembly.GetManifestResourceNames());
        using (var fileStream = Sys.ResourceAsStream(typeof(Program).Assembly, "cake.png"))
        {
